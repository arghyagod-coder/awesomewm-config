...
sudo apt update
sudo apt install awesome fonts-roboto rofi picom i3lock xclip qt5-style-plugins  lxappearance light flameshot nautilus xfce4-power-manager pnmixer network-manager-applet gnome-polkit -y
...
```
git clone https://github.com/saichaitanya278/awesomewm.git ~/.config/awesome
```
